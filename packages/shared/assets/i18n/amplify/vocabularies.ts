...
export const vocabularies = {
  ja: {
    ...
    [Translations.CREATE_ACCOUNT_TEXT]: 'H2Uアカウントの登録', //  "Create account",
    [Translations.EMAIL_LABEL]: 'メールアドレス', //  "Email Address *",
    [Translations.EMAIL_PLACEHOLDER]: 'メールアドレスを入力', //  "Enter your email address",
    [Translations.FORGOT_PASSWORD_TEXT]: 'パスワードを忘れた方', //  "Forgot your password?",
    ...
    [Translations.RESET_PASSWORD_TEXT]: 'リセット', //  "Reset password",
    ...
    [Translations.SIGN_IN_HEADER_TEXT]: 'H2Uにログイン', //  "Sign in to your account",
    [Translations.SIGN_IN_TEXT]: '既にアカウントをお持ちの方', //  "Sign in",
    ...
    [Translations.SIGN_UP_HEADER_TEXT]: 'H2Uアカウントの登録', //  "Create a new account",
