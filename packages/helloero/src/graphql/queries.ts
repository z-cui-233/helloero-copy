...
`;
export const userWabikenMetaByOwnerByContentDisplayNameKana = /* GraphQL */ `
  query UserWabikenMetaByOwnerByContentDisplayNameKana(
    $owner: String!
    $contentDisplayNameKana: ModelStringKeyConditionInput
    $sortDirection: ModelSortDirection
    $filter: ModelUserWabikenMetaFilterInput
    $limit: Int
    $nextToken: String
